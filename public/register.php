                    ...
                    <form role="form" action="/register.php" method="POST">
                        <fieldset>
                            <div class="form-group <?php if (isset($registerErrors['email'])): ?>has-error<?php endif ?>">
                                ...
                                <?php endif ?>
                                <input class="form-control" placeholder="E-mail" name="email" type="email" required autofocus id="login-email">
                            </div>
                            <div class="form-group <?php if (isset($registerErrors['password'])): ?>has-error<?php endif ?>">
                                ...
                                <?php endif ?>
                                <input class="form-control" placeholder="Password" name="password" type="password" required value="" id="login-password">
                            </div>
